...
void coinbase_create(YAAMP_COIND *coind, YAAMP_JOB_TEMPLATE *templ, json_value *json_result)
{
	...
	char script2[32] = "6d696e696e67706f6f6c"; // "miningpool" in hex ascii - use converter at https://www.rapidtables.com/convert/number/ascii-to-hex.html
	...
	if (strcmp(coind->symbol, "BMN") == 0)
{
	...
	if(strcmp(coind->symbol, "DEM") == 0){if(coind->txmessage){strcat(templ->coinb2, "00");}} //fixes eMark.
    	...
    	if(strcmp(coind->symbol, "TNSR") == 0){if(coind->txmessage){strcat(templ->coinb2, "00");}} //fixes TNSR maybe ?
	strcat(templ->coinb2, "00000000"); // locktime
